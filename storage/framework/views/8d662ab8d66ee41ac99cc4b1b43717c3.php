            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Dashboard Kelompok B</h3>
                </div>
                <div class="card-body">
...
<?php echo $__env->make('layouts.user_type.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\UUL\smster 7\IAK\dashboard_transportasi_iak-main\resources\views/session/login-session.blade.php ENDPATH**/ ?>